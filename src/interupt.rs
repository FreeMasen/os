...
lazy_static! {
    pub static ref IDT: InterruptDescriptorTable = {
        ...
        i[InterruptIndex::Timer.as_usize()]
            .set_handler_fn(timer);
        i[InterruptIndex::Keyboard.as_usize()]
...
pub const PICS: spin::Mutex<ChainedPics> = spin::Mutex::new(unsafe { ChainedPics::new(PIC_1_OFFSET, PIC_2_OFFSET)});
